...
- Version `risk-engine-3.0.2`; explainable 0–100 index, not a probability.
...
- Version `coverage-engine-2.0.0`; weighted score normalized to 100.
...
- `VERIFIED_RUNTIME`: final full suite: 639 passed in 1.68s.
...
- Work is local on `codex/risk-summary-product-recovery` from `7037a3f96b025c3021bb6ce0805d58a8f0505679`.
- No commit, push, PR, merge, checkout, reset, clean or stash was performed.
- Final `git diff --check` is clean. The working tree intentionally contains the uncommitted implementation listed in the handoff.
