...
class FirmotekaCrawlRun(Base):
    ...
    daily_refresh_horizon_days: Mapped[int] = mapped_column(Integer, nullable=False, default=7, server_default=text("7"))
    daily_refresh_budget: Mapped[int] = mapped_column(Integer, nullable=False, default=1, server_default=text("1"))
