...
- На исходном `c2b440b`: **361 passed**. После исправлений W1-001: **384 passed** в изолированной среде Python 3.13 (unit tests, не проверка PostgreSQL на Mac).
- Свежий результат PostgreSQL/Chromium CI фиксируется отдельно в PR и `docs/W1_001_ACCEPTANCE.md`.
...
- **W1-001 CBR Warning List:** код, миграция и блок карточки есть; текущая задача — приёмка по шести критериям. Полный импорт в PostgreSQL на Mac пока не подтверждён.
